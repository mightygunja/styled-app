...
const DEFAULT_QUICK_ACCESS: QuickAccessItem[] = [
  ...
  },
  {
    ...
    subtitle: 'Declutter & capsules',
    icon: '▤',
    route: 'ClosetOrganization',
    color: '#2B1F1A',
  },
...
export const AVAILABLE_QUICK_ACCESS_ITEMS: QuickAccessItem[] = [
  ...
  },
  {
    id: 'smart-search',
    title: 'Smart Search',
    subtitle: 'Find anything in your closet',
    icon: '◒',
    route: 'SmartSearch',
    color: '#2B1F1A',
  },
  ...
  },
  {
    ...
    subtitle: 'Deep wardrobe insights',
    icon: '▥',
  ...
  },
  {
    ...
    subtitle: 'CO₂ from your closet',
    icon: '◕',
    route: 'CarbonCalculator',
    color: '#2B1F1A',
  },
  {
    id: 'explore',
    title: 'Explore',
    subtitle: 'Trending styles & people',
    icon: '◈',
    route: 'Explore',
    color: '#2B1F1A',
  },
