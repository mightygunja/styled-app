...
export default function AppleWatchScreen() {
  ...
  const loadData = async () => {
    try {
      ...
      const [
        ...
        appleWatchService.getWatchSettings(MOCK_USER_ID),
        appleWatchService.getTodaysOutfit(MOCK_USER_ID),
        appleWatchService.getOutfitSuggestions(MOCK_USER_ID),
        appleWatchService.getWatchActivity(MOCK_USER_ID),
        appleWatchService.getWatchStats(MOCK_USER_ID),
  ...
  const handleUpdateSettings = async (updates: Partial<WatchSettings>) => {
    ...
    try {
      const updated = await appleWatchService.updateWatchSettings(MOCK_USER_ID, updates);
      setSettings(updated);
  ...
  const handleSync = async () => {
    try {
      ...
      const result = await appleWatchService.syncWithWatch(MOCK_USER_ID);
