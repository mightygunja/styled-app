...
export default function ShoppingAssistantScreen() {
  ...
  const [selectedTab, setSelectedTab] = useState<'recommendations' | 'budget'>('recommendations');
    ...
    <View key={rec.id} style={styles.recCard}>
      ...
      <View style={styles.recContent}>
        ...
        <View style={styles.recActions}>
          <TouchableOpacity style={styles.recActionButton}>
            <Text style={styles.recActionText}>View Details</Text>
          </TouchableOpacity>
          <TouchableOpacity style={[styles.recActionButton, styles.recActionButtonPrimary]}>
            <Text style={styles.recActionTextPrimary}>Add to List</Text>
          </TouchableOpacity>
        </View>
