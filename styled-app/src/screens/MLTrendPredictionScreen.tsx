  ...
  const loadData = async () => {
    try {
      ...
      const [trendData, analysisData, recommendationData, alertData, colorData] = await Promise.all([
        ...
        mlTrendPredictionService.getTrendAnalysis(MOCK_USER_ID),
        mlTrendPredictionService.getPersonalizedRecommendations(MOCK_USER_ID),
        mlTrendPredictionService.getTrendAlerts(MOCK_USER_ID),
