  ...
  .https.onCall(async (data, context) => {
    ...
    const challenges = [
      ...
      },
      {
        ...
        description:
          'Cream, camel, charcoal, bone. Prove that a restricted palette is a discipline rather than a limitation - texture and silhouette have to do all the work.',
        theme: 'Colour',
      ...
      },
      {
        ...
        title: 'The £30 outfit',
        description:
          'An outfit where every piece cost under £30, or was secondhand. Show the cost-per-wear if you have it - the best answers here are usually the oldest pieces.',
        theme: 'Value',
